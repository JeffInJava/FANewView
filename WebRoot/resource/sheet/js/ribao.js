...
function getLineFlux(id,type){
	...
	doPost("sheet/get_avg_flux.action", {"type":type,"date":nowDate,"controlDate":controlDate,"id":id}, function(data2){
		...
		//表格
		var _tempHtml = "<table align='left' width='100%'><tr align='left'>"
		for (var i=0;i<viewLineNow.length ;i++ ){
			...
			if (viewLineControl[i]*1 <= viewLineNow[i]*1){
				_color = "red";
				//tp_per+="<img src='style/dailysheet/images/up_arrow.png' height='10' width='10'/>";
			}else{
				_color = "#06b358";
				//tp_per+="<img src='style/dailysheet/images/down_arrow.png' height='10' width='10'/>";
			}
