(function(a) {
	a.msie = /msie/.test(navigator.userAgent.toLowerCase()),
    a.alerts = {
        verticalOffset: -75,
        horizontalOffset: 0,
        ...
        _overShow: function(d, c) {
            ...
            var e = (a.msie && parseInt(a.browser.version) <= 6) ? "absolute" : "fixed";
        ...
        _overReposition: function() {
            ...
            if (a.msie && parseInt(a.browser.version) <= 6) {
        ...
        _show: function(j, b, k, g, m, l, c, f, n) {
            ...
            var i = (a.msie && parseInt(a.browser.version) <= 6) ? "absolute" : "fixed";
