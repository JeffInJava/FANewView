...
<html>
  ...
  <body style="background-color:rgba(20,38,56,1);">
  	  ...
  	  <div class="titleCla">
  	  	 ...
  	  	 <div id="titleId" style="float:left;margin-left:100px;margin-top:8px;">
			 ...
			 <!-- 
			 <el-button type="primary" size="small" @click="addCameraImgBtn">摄像头</el-button>
			 <el-button type="primary" size="small" @click="addStationImgBtn">站层图</el-button>
			  -->
