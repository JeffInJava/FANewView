    ...
    <script type="text/javascript">
    	...
    	function loadFluxPeriodData(){
    		...
    		doPost("station/get_fluxperiod.action", {"start_date":start_date,"com_date":com_date,"sel_flag":"2","flux_flag":tp,"line_id":line_id,"station_id":station_id}, function(data){
	    		...
	    		flowPeriodOption.legend.data=[dateFt0,dateFt1];
	    		flowPeriodOption.series[0].name=dateFt0;
	    		flowPeriodOption.series[1].name=dateFt1;
	    		
	    		var times=[],com_times=[],period=[];
	    		$.each(data,function(i,v){
	    			times.push(v.TIMES);
		    		com_times.push(v.COM_TIMES);
	    			period.push(v.TIME_PERIOD);
	    		});
		    	flowPeriodOption.series[0].data=times;
	    		flowPeriodOption.series[1].data=com_times;
		    	...
		    	//填充图表数据
			     ...
			     function (ec) {
			     	var chartStation = ec.init(document.getElementById('mainPeriond')); 
		    ...
		    series : [
		    	{
		            name:'',
		            type:'line',
		            itemStyle: {normal: {color:'rgba(255,127,80,1)',areaStyle: {type: 'default'}}},
		            data:[]
		        },
		    	{
		            name:'',
		            type:'line',
		            itemStyle: {normal: {color:'rgba(46,199,201,1)',areaStyle: {type: 'default'}}},
		            data:[]
		        }
		    ]
		};
