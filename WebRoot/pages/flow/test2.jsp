...
<body>
		         	...
		         	<div data-v-3e377044 class="filter">
		         		...
		         		<div class="prm">
			         		...
			         		<select name="line_id" id="line_id1">
							  <option value="09">9号线3期</option>
							</select>
							<select name="ranking" id="ranking1">
							  <option value="20" selected="selected">全部</option>
	...
	<script type="text/javascript">
    	...
    	function loadStationRankData(){
    		...
    		doPost("station/get_ninestation_fluxrank.action", {"start_date":start_date,"flux_flag":tp}, function(data){
    	...
    	function loadFluxPeriodData(){
    		...
    		//同比数据
    		doPost("station/get_fluxperiod.action", {"start_date":"<%=start_date %>","com_date":"<%=tb_date%>","sel_flag":"2","flux_flag":tp,"line_id":line_id,"station_id":station_id}, function(data){
    		...
    		//环比数据
    		doPost("station/get_fluxperiod.action", {"start_date":"<%=start_date %>","com_date":"<%=hb_date%>","sel_flag":"2","flux_flag":tp,"line_id":line_id,"station_id":station_id}, function(data){
    			periodData=data;
