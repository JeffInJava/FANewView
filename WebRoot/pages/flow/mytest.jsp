        ...
        <div data-v-0b39df2e class="flex-container column">
            ...
            <div data-v-0b39df2e class="item four" data-order=""
                ...
                <div data-v-c5b8f8b4 data-v-0b39df2e class="point" id="kllx">
                    ...
                    <div data-v-c5b8f8b4 class="filter">
                        ...
                        <div class="prm">
                            ...
                            对比日期：<input type="text" name="com_date" id="com_date1" value="<%=yesterday %>"
                                        style="width:70px;height: 25px">
                    ...
                    <div data-v-c5b8f8b4 class="filter">
                        ...
                        <div class="prm">
                            运营日期：<input type="text" name="start_date" id="start_date2" value="<%=start_date %>"
                                        style="width:70px;height: 25px">
                            对比日期：<input type="text" name="com_date" id="com_date2" value="<%=yesterday %>"
                                        style="width:70px;height: 25px">
                ...
                <div data-v-c5b8f8b4 data-v-0b39df2e class="point" id="zl">
                    ...
                    <div id="mainChartZL" class="srank" style=""></div>
                    ...
                    <div data-v-c5b8f8b4 class="filter">
                        ...
                        <div class="prm">
                            运营日期：<input type="text" name="start_date" id="start_date3" value="<%=start_date %>"
                                        style="width:70px;height: 25px">
                            对比日期：<input type="text" name="com_date" id="com_date3" value="<%=yesterday %>"
                                        style="width:70px;height: 25px">
...
<script type="text/javascript">
    ...
    //加载车站客流增幅排名数据
    var zftbData, zfhbData, zfzdyData, zflx, titler;
    function loadStationComData() {
        ...
        titler = title;
        if(kllx=='zf_hb'||kllx=='zf_tb'||kllx=='zf_zdy'){
        ...
        zftbData = new Array();
        //同比数据
         doPost("station/get_station_fluxcompare.action", {
    ...
    function zfchart(zflx) {
        ...
        function addColumn() {
            ...
            g.transition()
                    .duration(2500)
                    .attr("transform", function (d) {
                        return "translate(" + (d.ox + margin.left + 20) + ", " + (yLinearScale(d.ADD_PER) + margin.bottom - 15) + ")"
                    });
            ...
            g.append('rect')
                    ...
                    .duration(2500)
                    .attr("height", function (d, i) {
                        return svgHeight - margin.bottom - margin.top - yLinearScale(d.ADD_PER);
                    });
            ...
            g.append('path')
                    ...
                    .duration(2500)
                    .attr("d", function (d, i) {
                        return "M" + d.ow + ",0 L" + d.p2.x + "," + d.p2.y + " L" + d.p3.x + "," + (d.p3.y + svgHeight - margin.top - margin.bottom - yLinearScale(d.ADD_PER)) + " L" + d.ow + "," + (svgHeight - margin.top - margin.bottom - yLinearScale(d.ADD_PER)) + " L" + d.ow + ",0"
                    });
            //添加文字元素
            g.append("text").attr("class", "myText")
                    .attr("x", 7)
    ...
    //加载车站客流增量排名数据
    var zltbData, zlhbData, zlzdyData, zllx, titles;
    function loadStationTimeComData() {
       ...
       // $(".btn").val(">>");
        ...
        if(kllx=='zl_hb'||kllx=='zl_tb'||kllx=='zl_zdy'){
    ...
    function zlchart(zllx) {
        //使用d3js画图表
        var svg = d3.select('#mainChartZL')
                .append('svg')
                .attr('width', svgWidth)
                .attr('height', svgHeight)
                .attr('id', 'svg-column');
        ...
        var createTooltipTableData = function (info) {
            ...
            ary.push("<div class='tip-hill-div'>");
            ary.push("<h1>站台信息：" + info.STATION_NM + "</h1>");
            ary.push("<h2>增加量: " + '+' + info.ADD_TIMES);
            ary.push("</div>");
            return ary.join("");
        };
        ...
        function addColumn() {
            ...
            g.transition()
                    .duration(2500)
                    .attr("transform", function (d) {
                        return "translate(" + (d.ox + margin.left + 20) + ", " + (yLinearScale(d.ADD_TIMES) + margin.bottom - 15) + ")"
                    });
            ...
            g.append('rect')
                    ...
                    .duration(2500)
                    .attr("height", function (d, i) {
                        return svgHeight - margin.bottom - margin.top - yLinearScale(d.ADD_TIMES);
                    });
            ...
            g.append('path')
                    ...
                    .duration(2500)
                    .attr("d", function (d, i) {
                        return "M" + d.ow + ",0 L" + d.p2.x + "," + d.p2.y + " L" + d.p3.x + "," + (d.p3.y + svgHeight - margin.top - margin.bottom - yLinearScale(d.ADD_TIMES)) + " L" + d.ow + "," + (svgHeight - margin.top - margin.bottom - yLinearScale(d.ADD_TIMES)) + " L" + d.ow + ",0"
                    });
            //添加文字元素
            g.append("text").attr("class", "myText")
                    .attr("x", 7)
