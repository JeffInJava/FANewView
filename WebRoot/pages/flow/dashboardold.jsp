...
<%--							<td></td>--%>
	...
	<script type="text/javascript">
    	...
    	function loadQrcdFluxIncome(){
    		doPost("qrcd/get_qrcdfluxincome.action", {"sel_flag":"flux"}, function(data){
    			if(data){
    	...
    	function loadQrcdFluxPer(){
    		doPost("qrcd/get_qrcdfluxincome.action", {"sel_flag":"qrcdper"}, function(data){
    			if(data){
    	...
    	function loadQrcdTrans(){
    		doPost("qrcd/get_qrcdfluxincome.action", {"sel_flag":"jy"}, function(data){
    			if(data){
    				$.each(data,function(i,v){
    	...
    	function loadQrcdLineFluxInc(){
    		doPost("qrcd/get_qrcdlineflux.action", {"sel_flag":"line"}, function(data){
    			if(data){
    	...
    	function loadQrcdStationFlux(lineId){
    		...
    		//加载“线路分时客流”
    		doPost("qrcd/get_qrcdlineflux.action", {"sel_flag":"period","line_id":lineId}, function(data){
    			if(data){
    		...
    		//加载“线路下车站客流”
    		doPost("qrcd/get_qrcdlineflux.action", {"sel_flag":"station","line_id":lineId}, function(data){
    			if(data){
    	...
    	function loadQrcdAllLineFlux(){
    		...
    		$("#enterFluxCpDialog").hide();
    		$("#allLineDialog").show();
    		doPost("qrcd/get_qrcdalllineflux.action", {"sel_flag":"period"}, function(data){
    			if(data){
    				linePeriodFluxOption.xAxis[0].data=[];
    				linePeriodFluxOption.series[0].data=[];
    				linePeriodFluxOption.series[1].data=[];
    	...
    	function loadQrcdPeriodCpFlux(){
    		...
    		doPost("qrcd/get_qrcdperiodcp.action", {"sel_flag":"period_cp","start_date":start_date,"compare_date":compare_date,"seg":seg}, function(data){
    			if(data){
    	...
    	function loadQrcdStationRank(){
    		...
    		doPost("qrcd/get_qrcdlineflux.action", {"sel_flag":"rank","flux_flag":flux_flag}, function(data){
    			if(data){
