    ...
    <div data-v-0b39df2e class="dashboard router-view">
        <div data-v-0b39df2e class="flex-container column">
            ...
            <div data-v-0b39df2e class="item three" data-order="4"
                 style="transform: translate(-29%,-19.2%) scale(0.28)">
                <div data-v-581634c4 data-v-0b39df2e class="line">
                    <div class="main" id="mainStationPZL">
                    	<img src="resource/images/leftbgyes.png" id="klkllxna"
                             style="height: 55%; width: 55%;z-index: 3;margin-left: 2%; " alt=""/>
                        <img src="resource/images/leftbgno.png" id="klkllxya"
                             style="height: 55%; width: 55%;z-index: 3;display:nonemargin-left: 2%; alt=""/>
                        
                        <img src="resource/images/chezssklo.png" id="klkllxoa" onclick="clickChart('0',this)"
                             style="position: absolute; height: 27%;width: 34%;z-index: 5;top: 16%;right: 51%" alt=""/>
                        <img src="resource/images/chezsskln.png" id="klkllxa" onclick="clickChart('0',this)"
                             style="position: absolute; height: 27%;width: 34%;z-index: 5;top: 16%;display:none;right: 51%" alt=""/>
                    </div>

                </div>
            </div>
            <div data-v-0b39df2e class="item one" data-order="4"
                 style="transform: translate(-29%,-6%) scale(0.28)">
                <div data-v-581634c4 data-v-0b39df2e class="line">
                    <div class="main" id="mainStationRank">
                        ...
                        <img src="resource/images/leftbgyes.png" id="klkllxn"
                             style="height: 55%; width: 55%;z-index: 3;margin-left: 2%; display:none" alt=""/>
                        <img src="resource/images/chezklpmy.png" id="klkllxo" onclick="clickChart('1',this)"
                             style="position: absolute; height: 27%;display:none;width: 34%;z-index: 5;top: 16%;right: 51%" alt=""/>
            ...
            <div data-v-0b39df2e class="item two" data-order="2"
                 style="transform: translate(-29%,7%) scale(0.28)">
                    ...
                    <div class="main" id="mainStationZF">
                        ...
                        <img src="resource/images/leftbgyes.png" id="klzfn"
                         ...
                         <img src="resource/images/chezklzfy.png" id="klzf" onclick="clickChart('2',this)"
                             style="position: absolute;display:none; height: 27%;width: 34%;z-index: 5;top: 19%;right: 51%" alt=""/>
                        <img src="resource/images/chezhklzfn.png" id="klzfo" onclick="clickChart('2',this)"
                             style="position: absolute; height: 27%;width: 34%;z-index: 5;top: 19%;right: 51%" alt=""/>
                    </div>
            ...
            <div data-v-0b39df2e class="item three" data-order="3"
                 style="transform: translate(-29%,19.8%) scale(0.28)">
                <div data-v-581634c4 data-v-0b39df2e class="line">
            ...
            <div data-v-0b39df2e class="item three" data-order="4"
                 style="transform: translate(-29%,32.5%) scale(0.28)">
                <div data-v-581634c4 data-v-0b39df2e class="line">
                    <div class="main" id="mainStationPZL">
            ...
            <div data-v-0b39df2e class="item three" data-order="4"
                 style="transform: translate(-29%,45.2%) scale(0.28)">
                <div data-v-581634c4 data-v-0b39df2e class="line">
                    <div class="main" id="mainStationPZL">
                        <img src="resource/images/leftbgno.png" id="ssklbgn"
                             style="height: 55%; width: 55%;z-index: 3;margin-left: 2%; alt=""/>
                        <img src="resource/images/leftbgyes.png" id="ssklbgo"
                             style="height: 55%; width: 55%;z-index: 3;margin-left: 2%; display:none" alt=""/>
                        <img src="resource/images/chezssklo.png" id="sskligo" onclick="clickChart('5',this)"
                             style="position: absolute; height: 27%;display:none;width: 34%;z-index: 5;top: 16%;right: 51%" alt=""/>
                        <img src="resource/images/chezsskln.png" id="ssklign" onclick="clickChart('5',this)"
                             style="position: absolute; height: 27%;width: 34%;z-index: 5;top: 16%;right: 51%" alt=""/>
                    </div>
            ...
            <div data-v-0b39df2e class="item four" data-order=""
                 style="transform: translate(19%, 0) scale(1)">
				 <div data-v-c5b8f8b4 data-v-0b39df2e class="point" id="tos">

                    <div id="tose" class="sranka" style="">
                        <iframe src="pages/tosnew/odflux_sel31.jsp" width="1500" height="690"></iframe>
                    </div>
                </div>
                <div data-v-c5b8f8b4 data-v-0b39df2e class="point" id="tosa">

                    <div id="toser" class="sranka" style="">
                        <iframe src="pages/tosnew/odflux_sel41.jsp" width="1500" height="690"></iframe>
                    </div>
                </div>
			...
			<div class="tabs">
                        ...
                        <div class="prm">
                            ...
                            <div id="ones" style="display: inline-block">
                                ...
                                <select name="station_id" id="ranking3" style="width:70px;height: 25px">
                                    ...
                                    <option value="5">前5</option>
                                    <option value="8">前8</option>
                                    <option value="18" selected="selected">全路网</option>
                                </select>
                            </div>
                ...
                <div data-v-c5b8f8b4 data-v-0b39df2e class="point" id="fs">
                    <div id="mainChartFS" class="sranks" style="width: 1550px;height:620px"></div>
...
<script type="text/javascript">
    ...
    function stationRankData(ranking, datas, tp) {
        //定义数据
         kldata = new Array();
        var title = "车站客流排名";
    ...
    function loadStationRankData() {
       ...
       // $(".tab").hide();
        ...
        var ranking = $("#ranking1").val();//排名
         ...
         doPost("station/get_station_fluxrank.action", {"start_date": start_date, "flux_flag": tp}, function (data) {
             var datas = data;
             stationRankData(ranking, datas, tp);
       ...
       /*   $("#line_id1").change(function () {
         ...
         $("#ranking1").change(function () {
             stationRankData($("#ranking1").val(), datas, tp);
         });
         });
    }
    //加载单个线路客流排名数据
