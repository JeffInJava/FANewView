...
<html>
  ...
  <body>
      ...
      <!-- 右侧悬浮框 start -->
      <div style="position:absolute;z-index:2;top:650px;left:5px;" onclick="showParam();">
	  ...
	  <div id="paramId" style="display:none;position:absolute;z-index:1;top:10px;left:20%;background:none repeat scroll 0 0 #D0DFFB;height:60px;width:600px;font-family: '微软雅黑';">
	  	<table height="60px" width="100%">
	  		<tr>
	  			<td>日期:<select id="start_date" name="start_date" style="width:100px;"></select></td>
	  			<td>参数类型:<select id="param_type" style="width:150px;"></select>
