  ...
  <body style="height:100%;width:100%;">
      ...
      <script type="text/javascript">
      	...
      	function sel_odflux(){
		    ...
		    //请求断面相关数据
		    doPost("odflux/get_enterodfluxnew.action",{"flag":1,"startDate":start_date,"stations":stations.substring(0,stations.length-1),"hour":$("#hour").val()},function(data){
		    	//车站排名数据
      	...
      	function getTotalStation(start_date,stations,hour){
	        doPost("odflux/get_enterodfluxnew.action",{"flag":4,"startDate":start_date,"stations":stations,"hour":hour},function(data){
	        	totalFlux=data;
      	...
      	function getRangStation(start_date,stations,hour){
	        doPost("odflux/get_enterodfluxnew.action",{"flag":2,"startDate":start_date,"stations":stations},function(data){
	        	var tp_ht="";
	        	$.each(data,function(i,v){
	        		if(v.FLAG=="1"){
      	...
      	function getExitChgFlux(){
		    doPost("odflux/get_enterodfluxnew.action",{"flag":3},function(data){
		    	$.each(data,function(i,v){
