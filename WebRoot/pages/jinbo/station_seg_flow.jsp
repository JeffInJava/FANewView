...
<body>
	<div id="segFlow" style="margin-left: 15px;">
		<el-row> <template>
		<div class="block">
			<el-carousel height="270px" width="550px" v-for="" @change="stationChange" autoplay="false" interval="60000"> <el-carousel-item>
				<div id="st1" style="height: 270px;width:550px;"></div>
				</el-carousel-item> <el-carousel-item>
				<div id="st2" style="height: 270px;width:550px;"></div>
				</el-carousel-item> <el-carousel-item>
				<div id="st3" style="height: 270px;width:550px;"></div>
				</el-carousel-item> <el-carousel-item>
				<div id="st4" style="height: 270px;width:550px;"></div>
				</el-carousel-item> 
				<el-carousel-item>
				<div id="st5" style="height: 270px;width:auto;">
				<div class="mainApp" id="cocc" style="height:235px;">
				<div data-v-c5b8f8b4 data-v-0b39df2e class="point" id="zf"  style="height: 235px;width:auto;overflow-y:scroll;">
					<table id="coccTb" data-sort="sortDisabled" align="center" border="0" cellspacing="1" cellpadding="0" style="height:235px;word-break:break-all;">
				<tbody>
					<tr class="firstRow">
	...
	var vueSegFlow = new Vue({
		...
		methods : {
			...
			initChart:function(st){
				...
				var selectAll = sta.getOption().legend[0].data;
