		  		...
		  		$.post("lflw/GetonLineFlow.action",{"date":vueThis.adate,"compDate":vueThis.aweekdate}, function(data){
		  		   ...
		  		   for (var i=0;i<=data.times.length-1;i++){
		  		   		...
		  		   		var  it=data.times[i];
		  		   		 ...
		  		   		 tim.push({
				                 value: it,
				                 textStyle: {fontSize:12,fontWeight:'bold',color: 'rgba(255,255,255,1)'}
				             });
				...
				option = {
				    ...
				    tooltip: {
				        ...
				        formatter:function (p){
				        	var tp_str;
				        	if(p.length==2){
				        	 	tp_str = p[0].name + "<br/>" + p[0].seriesName + "： "+p[0].value+"万"
				    ...
				    yAxis: {
	                    ...
	                    axisLabel: {
	                        textStyle: {fontWeight: 'bold', fontSize: 16, color: '#FFFfff'}
	                    },
				        data: []
				    },
				    series: [
