...
<div class="mainApp">
                <div data-v-c5b8f8b4 data-v-0b39df2e class="point" id="fs">
                    <div id="mainChartFS" class="sranks" style="width: 1200px;height:500px"></div>

                    <div data-v-c5b8f8b4 class="filters" style="width: 1000px;">
   ...
   var startTimes;
    ...
    function loadFluxPeriodData() {
        ...
        periodAllData = {
            title: [{
                ...
                x: 'center',
                y:'0',
                textStyle: {fontSize: 27, fontWeight: 'bolder', color: '#FFFFFF'}
            }]
        };
        var tp_title = "";
        if (station_id) {
	...
	var unit='单位：万人次';
	 function setPeriodOptions() {
        ...
        var dateFt0 = startTimes.substring(0, 4) + "/" + startTimes.substring(4, 6) + "/" + startTimes.substring(6);
        var dateFt1 = endTimes.substring(0, 4) + "/" + endTimes.substring(4, 6) + "/" + endTimes.substring(6);
