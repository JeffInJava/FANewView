...
<script type="text/javascript">
 ...
 //判断当前时间 产生日期
    ...
    function loadAllLineRankData() {
        ...
        doPost("pflw/get_line_flux_max.action", {"start_date": adate, "flux_flag": tp}, function (data) {
            var datas = data;
            AlllineRankData(datas);
  ...
  //所有线路车站排名
    ...
    function AlllineRankData(datas) {
        //定义数据
        aldata = new Array();
        var title = "全路网线路客流排名";
     var hs=datas.hst;
