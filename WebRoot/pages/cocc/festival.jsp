...
<!-- 	                	<img src="resource/images/pasflw/xlklbiaoti.png" alt=""/> -->
	  	  		...
	  	  		<el-row>
	  	  			<div id="" style="float: left;
						    ...
						    width: 540px;
						    height: 280px;">
						    <iframe id="alinea" src="pages/pflows/alllineflow.jsp" frameBorder="0" width="540" height="280"></iframe>
	           		 </div>		
	  	  		</el-row>
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: 16px;margin-left: 0px;" @click="klzfDetl()">
	  	  			...
	  	  			<div id="" style="float: left;
						    ...
						    height: 240px;">
						    	<div id="" style="float: left;position:absolute;
								    ...
								    width: 510px;
								    height: 260px;">
								    <iframe id="isnflwa"src="pages/lineflow/instantFlw.jsp" frameBorder="0" width="500" height="260"></iframe>
	           		 			</div>	
	           		 </div>		
	  	  		</el-row>
	  	  		<el-row v-if="showLine">
	  	  			<div style="float: left;margin-top: 16px;margin-left: 0px;" @click="coccLineDetl()">
	  	  		...
	  	  		<el-row v-if="showLine">
	  	  			<div id="zdcz" style="float: left;margin-top: 16px;margin-left: 33px;width: 535px;height: 210px;margin: 0px 0px 10px -15px;">
	                	  <iframe id="gqla" src="pages/cocc/board_line.jsp" frameBorder="0" width="535" height="210" scrolling="auto"></iframe>
	           		 </div>		
	  	  		</el-row>
	  	  		<el-row v-if="showStation">
	  	  			<div style="float: left;margin-top: 16px;margin-left: 0px;" @click="coccStationDetl()">
	                	<div class="" style="float: left;margin-top: 42px;margin-left: 0px;font-size: 22px;font-weight: bolder;color:#ffffff">
								  	  				重点关注车站客流
								  	  			</div>
	           		 </div>		
	  	  		...
	  	  		<el-row v-if="showStation">
	  	  			<div id="zdcz_station" style="float: left;margin-top: 16px;margin-left: 33px;width: 535px;height: 210px;margin: 0px 0px 10px -15px;">
	                	  <iframe id="gqsa" src="pages/cocc/board_station.jsp" frameBorder="0" width="535" height="210" scrolling="auto"></iframe>
	           		 </div>		
	  	  		</el-row>
	  	  		<el_row>
	  	  			<div style="float: left;margin-top: 0px;margin-left: 90px;width: 155px">
						<el-row>
							<div class="tab" style="float: left;margin-top: 0px;margin-left: -17px;">
								<span id="spline" class="act" @click="coccDisplay('line')">线路</span>
          		 			</div>
						</el-row>
					</div>
					<div style="float: left;margin-top: 0px;margin-left: 90px;width: 155px">
						<el-row>
							<div class="tab" style="float: left;margin-top: 0px;margin-left: -17px;">
               					<span id="spstation" @click="coccDisplay('station')">车站</span>
               				</div>
						</el-row>
					</div>
	  	  			<!-- <div style="float: left; margin-top: 0px; margin-left: 90px; width: 155px;"><div class="el-row"><div style="float: left; margin-top: 0px; margin-left: -17px;" @click="coccDisplay('line')"><img src="resource/images/pasflw/list-1.png" alt=""></div></div></div>
				    <div style="float: right; margin-top: 0px; margin-right: 90px; width: 155px;"><div class="el-row"><div style="float: left; margin-top: 0px; margin-left: -17px;" @click="coccDisplay('station')"><img src="resource/images/pasflw/list-3.png" alt=""></div></div></div> -->
	  	  		</el_row>
	  	  	</el-col>
	  	  	...
	  	  	<el-col :span="7">
	  	  		...
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: 16px;margin-left: 0px;" @click="qyklDetl()">
	                	<!-- <img src="resource/images/pasflw/xzqklbiaoti.png" alt=""/> -->
	  	  		...
	  	  		<el-row>
	  	  			<div style="float: left;
						    ...
						    height: 260px;">
							    ...
							    <iframe id="onlfla" src="pages/lineflow/onlineFlw.jsp" frameBorder="0" width="490" height="260"></iframe>
	  	  	...
	  	  	<el-row>
					...
					<iframe id="gqcza"src="pages/cocc/station_flow_model_gq.jsp?viewFlag=true" frameBorder="0" width="470" height="260"></iframe>
						  </div>
				  ...
				  <div id="fullsc" class="dialog-container " v-show="isShow">
				    <div class="" style="width:100%;height:40px;border-radius:5px 5px 0px 0px;background:#fff">
				      <div style="  float: left;height:100%;width:100%;text-align:center
					    ...
					    font-size: 26px;
					    font-weight: bolder;
				   		 color: rgb(0, 204, 198);"  @click="openDate">
				      	{{modalTitle}}
				      </div>
				   ...
				   <!--  <slot> -->
				      <div class="" style="height:100%;width:100%; background-color: #043735">
				        <div id="" v-show="xlpmsw" style="height:650px;width:1248px;padding: 2% 2%;">
				        	<iframe id="xlrank" src="pages/pflows/alllineflowc.jsp" frameBorder="0" width="1200" height="620"></iframe>
				        </div>
				        <div id="" v-show="qyklsw" style="height:650px;width:1248px;padding: 2% 1%;">
				        	<iframe id="qyklsw" src="pages/lineflow/olflow.jsp" frameBorder="0" width="1200" height="620"></iframe>
				        </div>
				        ...
				        <div id="" v-show="czydsw" style="height:650px;width:1248px;padding: 2% 2%;">
				        	<iframe id="zdczrk" src="pages/cocc/station_flow_model_gq.jsp" frameBorder="0" width="1200" height="620"></iframe>
				        </div>
						...
						<div id="" v-show="cocclinesw" style="height:650px;width:1248px;position: relative;padding: 2% 2%;">
						<input id="cocc_view" value="1" type="text" hidden>
					        <iframe id="coccline" src="pages/cocc/board_line_all.jsp" frameBorder="0" width="1200" height="620"></iframe>
						</div>
						<div id="" v-show="coccStationsw" style="height:650px;width:1248px;position: relative;padding: 2% 2%;">
					        <iframe id="coccstation" src="pages/cocc/board_station_all.jsp" frameBorder="0" width="1200" height="620"></iframe>
						</div>
	            	...
	            	<div id="" style="float: left;margin-top: -73px;margin-left: 0px;width:1200px;height:60px">
						...
						<div id="" v-show="klzfsw" style="height:650px;width:1248px;position: relative;padding: 15px 20px;">
							<iframe id="fsklrk" src="pages/lineflow/instFlwa.jsp" frameBorder="0" width="1200" height="620"></iframe>
  ...
  <script type="text/javascript">
  	 /* function notifyifram(type,params){
  	 		alert("被调用");
		  	if(type="allline"){
		  		document.getElementById('alinea').contentWindow.dataRefresh(params);
		  	}
      ...
      //自定义一个过滤器，用于在页面上显示年月日格式
		...
		window.getRefreshLineData = this.getRefreshLineData;
		window.getRefreshStationData = this.getRefreshStationData;
        },
		  methods: {
		  //初始化页面
		  initData:function(){
		  ...
		  ifresh:function(){
		  		...
		  		document.getElementById('gqla').contentWindow.location.reload(true);
		  		//document.getElementById('gqsa').contentWindow.location.reload(true);
		  		...
		  		document.getElementById('coccline').contentWindow.location.reload(true);
		  ...
		  Allrefresh:function(){
		  		...
		  		this.getFlow();
		  		document.getElementById('xlrank').contentWindow.searchAllLineRankData();
		  		document.getElementById('qyklsw').contentWindow.searchLineRankData();
		  		document.getElementById('czklrk').contentWindow.searchStationRankData();
		  		document.getElementById('zdczrk').contentWindow.search();
		  		document.getElementById('coccline').contentWindow.getVisitpfw();
		  		document.getElementById('coccstation').contentWindow.getVisitpfw();
		  		document.getElementById('tosb').contentWindow.loadSvg();
		  ...
		  getRefreshLineData:function(startTime,compareTime){
			  document.getElementById('gqla').contentWindow.dataRefresh(startTime,compareTime);
		  },
		  getRefreshStationData:function(startTime,compareTime,modelId,subModelName){
		      document.getElementById('gqsa').contentWindow.dataRefresh(startTime,compareTime,modelId,subModelName);
		  },
		  ...
		  getGqlflow:function(){
		  		 var vueThis=this;
		  	 vueThis.gqldtms1=vueThis.gqlDate1;
		  	 vueThis.gqldtms2=vueThis.gqlDate2;
		  	 vueThis.gqlDate1=moment(vueThis.gqlDate1).format("YYYYMMDD");
		  		 vueThis.gqlDate2=moment(vueThis.gqlDate2).format("YYYYMMDD");
		  		 document.getElementById('gqla').contentWindow.updateView(vueThis.gqlDate1,vueThis.gqlDate2);
		  		 if(vueThis.showStation){
		  		 	document.getElementById('gqsa').contentWindow.updateView(vueThis.gqlDate1,vueThis.gqlDate2);
		  		 }
		  		 document.getElementById('coccline').contentWindow.updateView(vueThis.gqlDate1,vueThis.gqlDate2);
		  		 document.getElementById('coccstation').contentWindow.updateView(vueThis.gqlDate1,vueThis.gqlDate2);
		  		 vueThis.gqlDate1=vueThis.gqldtms1;
		  		 vueThis.gqlDate2=vueThis.gqldtms2;
		  },
		  //按日期查询国庆车站客流
		  getGqzflow:function(){
		  	 var vueThis=this;
		  	 vueThis.gqzdtms1=vueThis.gqzDate1;
		  	 vueThis.gqzdtms2=vueThis.gqzDate2;
		  	 vueThis.gqzDate1=moment(vueThis.gqzDate1).format("YYYYMMDD");
		  		 vueThis.gqzDate2=moment(vueThis.gqzDate2).format("YYYYMMDD");
		  		 document.getElementById('gqcza').contentWindow.upData(vueThis.gqzDate1,vueThis.gqzDate2);
		  		 document.getElementById('zdczrk').contentWindow.upData(vueThis.gqzDate1,vueThis.gqzDate2);
		  		 vueThis.gqzDate1=vueThis.gqzdtms1;
		  		 vueThis.gqzDate2=vueThis.gqzdtms2;
		  },
		  //按日期查询分时客流
		  getFsflow:function(){
		  var vueThis=this;
		 ...
		 //document.getElementById('fsklrk').contentWindow.setPeriodOptions();  
		  ...
		  vssiDetl:function(){
		  	var vueThis=this;
		  		...
		  		// document.getElementById('tos').contentWindow.ftmove();
		  ...
		  coccLineDetl:function(){
			  	var vueThis=this;
			  		...
			  		vueThis.zklquery=false;
			  		$('#cocc_view').val('0');
			  		//document.getElementById('coccline').contentWindow.xlpm();
						
			  },
			  coccStationDetl:function(){
				  	var vueThis=this;
				  		 ...
				  		 vueThis.czklsw=false;
				  		  ...
				  		  vueThis.zdczsw=false;
				  		  vueThis.cocclinesw=false;
				  		vueThis.coccStationsw=true;
				  		  vueThis.vssisw=false;
				  		vueThis.klzfsw=false;
				  		vueThis.modalTitle='';
				  		vueThis.zklquery=false;
				  		$('#cocc_view').val('0');
				  	//document.getElementById('coccstation').contentWindow.xlmp(); 
		  ...
		  coccDisplay:function(cocc){
			var vueshow = this;
			
			if(cocc=='line'){
				vueshow.showLine=true;
				vueshow.showStation=false;
				 $("#spstation").removeClass("act");
		  		 $("#spline").addClass("act");
			}
			if(cocc=='station'){
				vueshow.showLine=false;
				vueshow.showStation=true;
				$("#spline").removeClass("act");
		  		 $("#spstation").addClass("act");
			}
		  },
		  //分时客流
		  fsklDetl:function(){
		...
		zlzfswitch:function(sta){
		  ...
		  makedate:function(){
               ...
               this.olDate2=cpd;
                this.gqlDate1=Date.now();
               this.gqlDate2=cpd;
		   	this.gqzDate1=Date.now();
               this.gqzDate2=cpd;
		  },
		  ...
		  //刷新车站客流图表数据
		  setChzchart:function(data){
		  	var vueThis=this;
		  		console.log(data);
		  		var dat=data.stalist;
						//var hl=data.hst;
					var data_name = [];
					var data_val = [];
					for (var i=dat.length-1;i>=0;i--){
						console.log(data.hst[i].times);
						data_name.push(dat[i]['STATION_NM_CN']);
						data_val.push({value:dat[i]['IN_PASS_NUM'],hst:data.hst[i].times,hsday:data.hst[i].stmt_day});
					}
					vueThis.chzLine=data_name;
					vueThis.chzchartOption.yAxis[0].data = data_name;
					vueThis.chzchartOption.series[0].data = data_val;
		  ...
		  getChzchart:function(){
				...
				$.post("sheete/get_all_passe.action",{"id":0,"type":0,"date":vueThis.adate,"startTime":vueThis.when,"size":10,"selType":selTypes}, function(data){
