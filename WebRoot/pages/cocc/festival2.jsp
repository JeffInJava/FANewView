...
<!-- 	                	<img src="resource/images/pasflw/xlklbiaoti.png" alt=""/> -->
	  	  			...
	  	  			<div id="" style="float: left;
						    ...
						    height: 240px;">
						    	<div id="" style="float: left;position:absolute;
								    ...
								    width: 510px;
								    height: 260px;">
								    <iframe src="pages/lineflow/instantFlw.jsp" frameBorder="0" width="500" height="260"></iframe>
	           		 			</div>	
	           		 </div>		
	  	  		</el-row>
	  	  		<el-row v-if="showLine">
	  	  			<div style="float: left;margin-top: 6px;margin-left: 0px;" @click="coccLineDetl()">
	  	  		...
	  	  		<el-row v-if="showLine">
	  	  			<div id="zdcz" style="float: left;margin-top: 16px;margin-left: 33px;width: 535px;height: 210px;margin: 0px 0px 10px 0px;">
	                	  <iframe src="pages/cocc/board_line.jsp" frameBorder="0" width="535" height="210" scrolling="auto"></iframe>
	           		 </div>		
	  	  		</el-row>
	  	  		<el-row v-if="showStation">
	  	  			<div style="float: left;margin-top: 6px;margin-left: 0px;" @click="coccStationDetl()">
	                	<div class="" style="float: left;margin-top: 42px;margin-left: 0px;font-size: 22px;font-weight: bolder;color:#ffffff">
								  	  				cocc车站
								  	  			</div>
	           		 </div>		
	  	  		...
	  	  		<el-row v-if="showStation">
	  	  			<div id="zdcz_station" style="float: left;margin-top: 16px;margin-left: 33px;width: 535px;height: 210px;margin: 0px 0px 10px 0px;">
	                	  <iframe src="pages/cocc/board_station.jsp" frameBorder="0" width="535" height="210" scrolling="auto"></iframe>
	           		 </div>		
	  	  		</el-row>
	  	  		<el_row>
	  	  			<div style="float: left;margin-top: 0px;margin-left: 90px;width: 155px">
						<el-row>
							<div style="float: left;margin-top: 0px;margin-left: -17px;" @click="coccDisplay('line')">
					...
					<div style="float: left;margin-top: 0px;margin-left: 90px;width: 155px">
						<el-row>
							<div style="float: left;margin-top: 0px;margin-left: -17px;" @click="coccDisplay('station')">
	  	  		...
	  	  		<el-row>
	  	  			<div style="float: left;
						    ...
						    height: 260px;">
							    ...
							    <iframe src="pages/lineflow/onlineFlw.jsp" frameBorder="0" width="490" height="260"></iframe>
	  	  	...
	  	  	<el-row>
					...
					<iframe src="pages/cocc/station_flow_model.jsp?viewFlag=true" frameBorder="0" width="470" height="260"></iframe>
						  </div>
				   ...
				   <!--  <slot> -->
				      <div class="" style="height:100%;width:100%; background-color: #043735">
				        ...
				        <div id="" v-show="czydsw" style="height:650px;width:1248px;padding: 2% 2%;">
				        	<iframe id="zdczrk" src="pages/cocc/station_flow_model.jsp" frameBorder="0" width="1200" height="620"></iframe>
				        </div>
						...
						<input id="cocc_view" value="1" type="text" hidden>
					        <iframe id="coccline" src="pages/cocc/board_line.jsp" frameBorder="0" width="1500" height="620"></iframe>
						</div>
      ...
      //自定义一个过滤器，用于在页面上显示年月日格式
		...
		zlzfswitch:function(sta){
		  ...
		  vueThis.chzchart=myChart;
		   ...
		   //获取全路网车站客流和增量图表数据  
		  getChzzlchart:function(){
		  		var vueThis=this;
		  		 var selTypes=[1,3];
		  		 var week_date="<%=week_date%>";
				 
				$.post("sheete/get_all_passezl.action",{"id":0,"type":0,"date":vueThis.date,"compDate":week_date,"size":8,"selType":selTypes}, function(data){
