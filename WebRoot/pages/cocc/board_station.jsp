...
<body>
	<div class="mainApp" id="cocc" style="width:auto;height:auto;">
		<div v-show="slayer" style="height:12%;width:100%;" id="selBtnId" >
		...
		var vueStation = new Vue({
				...
				methods : {
					...
					dataRefresh:function(startTime,compareTime,modelId,subModelName){
						$.post("cocc/get_station_time_seg_flow.action", {
							"startTime" : startTime,
							"chainTime" : compareTime,
							"preview" : 1,
							...
							vueStation.timeSeg = data.timeSeg;
