  ...
  <body>
  	  <div id="pfwd">
  	  	...
  	  	<el-row>
	  	  	<el-col :span="8">
		  	  	<el-row>
	  	  			<div style="float: left;margin-top: 17px;margin-left: 33px;" @click="toFlow">
			...
			<el-col :span="8">
	  	  	...
	  	  	<el-col :span="8">
		  	  	<el-row>
	  	  			<div style="float: left;margin-top: 17px;margin-left: 17px;" @click="toTvm">
      ...
      <script type="text/javascript">
		...
		new Vue({
		  ...
		  //页面跳转
		  toFlow:function(){
		  	//window.location.href = "pages/pasgflwdtls.jsp";
		  	window.open("http://172.16.198.86:8080/FANew/pages/staticsboard/pasgflwdtls.jsp");
		  },
		   toTvm:function(){
		  	//window.location.href = "pages/pasgflwdtls.jsp";
		  	window.open("http://172.16.198.86:8080/TVMView/pages/indexa.jsp");
		  },
		  //获取设备数量
		  GetEqm:function(){
		  	var vueThis=this;
		  ...
		  getPFWsmy:function(){
		   ...
		   //加载TVM数据
    	getTVMdatas:function(){
    		 	var vueThis=this;
    		$.post("sheete/get_tvm.action", {"date":vueThis.date}, function(data){
    			if(data){
   					
   					var it=data;
   					vueThis.payTimes = it.sellTimes;
					vueThis.payAmount = it.totalAmount;
					vueThis.payNums = it.tradeTimes;
