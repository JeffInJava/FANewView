...
body {
	background: url("resource/images/pasflw/backgounds.png") no-repeat;
  ...
  <body>
  	  <div id="pfwd">
  	  	<el-row>
  	  		...
  	  		<div id="" style="float: left;margin-top: 10px;margin-left: 696px;width: 40px;height: 40px;">
  	  	...
  	  	<el-row>
	  	  	<el-col :span="8">
	  	  		...
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: 5px;margin-left: 33px;" @click="klzfDetl()">
	  	  			...
	  	  			<div id="" style="float: left;
						    ...
						    height: 240px;">
						    	<div id="" style="float: left;position:absolute;
								    ...
								    width: 420px;
								    height: 240px;">
								    <iframe src="pages/pflows/timecompflw.jsp" frameBorder="0" width="420" height="240"></iframe>
	           		 			</div>	
	           		 </div>		
	  	  		</el-row>
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: 10px;margin-left: 33px;" @click="zdczDetl()">
	  	  		...
	  	  		<el-row>
	  	  			<div id="zdcz" style="float: left;margin-top: 16px;margin-left: 33px;width: 430px;height: 260px;margin: 0px 23px 10px 35px;">
	                	  <iframe src="pages/pflows/linestaflow.jsp" frameBorder="0" width="430" height="260"></iframe>
	           		 </div>		
	  	  		</el-row>	  
	  	  	</el-col>
	  	  	<el-col :span="8">
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: 65px;margin-left: 260px;">
	  	  		...
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: 5px;margin-left: 0px;width:660px;height:320px">
	  	  			<div id="sjzl" style="float: left;margin-top: 45px;margin-left: -7px;">
	  	  		...
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: -42px;margin-left: 257px;" @click=" vssiDetl()">
	                	<!-- <img src="resource/images/pasflw/zdchzbiaoti.png" alt=""/> -->
	  	  		...
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: 5px;margin-left: -40px;width:720px;height:510px">
	                	<iframe src="pages/tosnew/odflux_sel31a.jsp" frameBorder="0" width="720" height="510"></iframe>
	           		 </div>		
	  	  		</el-row>
	  	  	...
	  	  	<el-col :span="8">
	  	  		...
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: 6px;margin-left: 145px;" @click="qyklDetl()">
	                	<!-- <img src="resource/images/pasflw/xzqklbiaoti.png" alt=""/> -->
	                	<div class="" style="float: left;margin-top: 10px;margin-left: 15px;font-size: 23px;font-weight: bolder;color:#ffffff">
								  	  				车站换乘客流
								  	  			</div>
	  	  	...
	  	  	<el-row>
	  	  			<div style="float: left;
						    ...
						    height: 260px;">
							    ...
							    <iframe src="pages/pflows/prmstaflow.jsp" frameBorder="0" width="430" height="260"></iframe>
				  ...
				  <div id="fullsc" class="dialog-container " v-show="isShow">
				    ...
				    <slot>
				      <div class="" style="height:100%;width:100%; background-color: #043735">
				        <div id="modalchar" v-show="xlpmsw" style="height:650px;width:1248px;padding: 2% 2%;"></div>
				        <div id="qyklchar" v-show="qyklsw" style="height:650px;width:1248px;padding: 2% 2%;"></div>
				        ...
				        <div id="" v-show="zdczsw" style="height:650px;width:1248px;position: relative;padding: 2% 2%;">
					        <iframe src="pages/pflows/linestaflowa.jsp" frameBorder="0" width="1200" height="620"></iframe>
						</div>
						...
						<div id="" v-show="klzfsw" style="height:650px;width:1248px;position: relative;padding: 15px 20px;">
							<iframe src="pages/pflows/timecompflwa.jsp" frameBorder="0" width="1200" height="620"></iframe>
