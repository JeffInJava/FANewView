...
body {
	background: url("resource/images/pasflw/bgd.png") no-repeat;
  ...
  <body>
  	  <div id="pfwd">
  	  	<el-row>
  	  		...
  	  		<div id="" style="float: left;margin-top: 7px;margin-left: 706px;width: 180px;height: 47px;">
	                	<img src="resource/images/pasflw/shmetro.png" style="width: 100%;height: 100%;"alt=""/>
	           		 </div>	
  	  	...
  	  	<el-row>
	  	  	<el-col :span="8">
		  	  	<el-row>
	  	  			<div id="modalBtn" style="float: left;margin-top: 10px;margin-left: 33px;" @click="xlpmDetl()">
	  	  		...
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: -10px;margin-left: 33px;" @click="klzfDetl()">
	                	<!-- <img src="resource/images/pasflw/xzqklbiaoti.png" alt=""/> -->
	                	<div class="" style="float: left;margin-top: 10px;margin-left: 15px;font-size: 23px;font-weight: bolder;color:#ffffff">
								  	  				分时客流
								  	  			</div>
	           		 </div>		
	  	  		</el-row>
	  	  		...
	  	  		<el-row>
	                	...
	                	<div class="" style="float: left;margin-top: 10px;margin-left: 12px;font-size: 24px;font-weight: bolder;color:#ffffff">
								  	  				线路车站客流
								  	  			</div>
	           		 </div>		
	  	  		</el-row>
	  	  		<el-row>
	  	  			<div id="zdcz" style="float: left;margin-top: 16px;margin-left: 33px;width: 470px;height: 280px;margin: 0px 23px 10px 35px;">
	                	  <iframe src="pages/pflows/linestaflowb.jsp" frameBorder="0" width="470" height="230"></iframe>
	           		 </div>		
	  	  		</el-row>	  
	  	  	</el-col>
	  	  	<el-col :span="8">
	  	  		<el-row>
	                	...
	                	<div class="" style="float: left;margin-top: 7px;margin-left: 15px;font-size: 23px;font-weight: bolder;color:#ffffff">
								  	  				数据总览
								  	  			</div>
	           		 </div>		
	  	  		</el-row>
	  	  		<el-row>
	  	  			<div id="shujuzl" style="float: left;margin-top: 5px;margin-left: 0px;width:660px;height:320px">
	  	  			
	  	  			<div id="sjzl" style="float: left;margin-top: 32px;margin-left: -7px;">
	  	  		...
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: -106px;margin-left: 257px;" @click=" vssiDetl()">
	                	<!-- <img src="resource/images/pasflw/zdchzbiaoti.png" alt=""/> -->
	                	<div class="" style="float: left;margin-top: 4px;margin-left: 15px;font-size: 22px;font-weight: bolder;color:#ffffff">
								  	  				实  时  客  流
								  	  			</div>
	           		 </div>		
	  	  		</el-row>
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: 5px;margin-left: -40px;width:720px;height:480px">
	                	<iframe src="pages/tosnew/odflux_sel31a.jsp" frameBorder="0" width="720" height="480"></iframe>
	           		 </div>		
	  	  		</el-row>
	  	  	...
	  	  	<el-col :span="8">
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: 10px;margin-left: 145px;height: 40px" @click="czklDetl()">
	  	  		...
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: -10px;margin-left: 145px;" @click="qyklDetl()">
	                	<!-- <img src="resource/images/pasflw/xzqklbiaoti.png" alt=""/> -->
	                	<div class="" style="float: left;margin-top: 10px;margin-left: 15px;font-size: 23px;font-weight: bolder;color:#ffffff">
								  	  				车站换乘客流
								  	  			</div>
	  	  		...
	  	  		<el-row>
	  	  			<div id=""  style="float: left;margin-top: 16px;width: 500px;height: 230px;margin: 10px 10px 10px 35px;">
	  	  		...
	  	  		<el-row>
	  	  			<div style="float: left;margin-top: -6px;margin-left: 159px;" @click="czydDetl()">
	                	<!-- <img src="resource/images/pasflw/yjzsbiaoti.png" alt=""/> -->
	                	<div class="" style="float: left;margin-top: 0px;margin-left: 15px;font-size: 23px;font-weight: bolder;color:#ffffff">
								  	  				重点车站客流
								  	  			</div>
	           		 </div>		
	  	  		</el-row>
	  	  	<el-row>
	  	  			<div style="float: left;
						    ...
						    height: 230px;">
							    ...
							    <iframe src="pages/pflows/prmstaflow.jsp" frameBorder="0" width="430" height="230"></iframe>
  	  	...
  	  	<div v-show="statochg" class="select-container " style=""> 
  	  		<el-row>
  	  			<template>
				  <el-transfer
				    filterable
				    :filter-method="filterMethod"
				    filter-placeholder="请输入车站名称"
				    v-model="stvalue"
				    :data="slcdata">
				  </el-transfer>
				</template>
  	  		</el-row>
  	  		<div id=""  style="float: left;margin-top: 16px;width: 200px;height: 40px;margin: 20px 10px 10px 150px;">
  	  			<el-row>
				  <el-button type="primary" round @click="getCzchange">确 认</el-button>
				  <el-button type="warning" round  @click="closeSlc">取 消</el-button>
				</el-row>
  	  		</div>
  	  	</div>
  	  		...
  	  		<div class="dialog-wrapper" @click="onClose" v-show="isShow"></div>
				  ...
				  <div id="fullsc" class="dialog-container " v-show="isShow">
				    <div class="" style="width:100%;height:40px;border-radius:5px 5px 0px 0px;background:#fff">
				      <div style="  float: left;height:100%;width:100%;text-align:center;line-height: 40px;
					    margin-top: 0px;
					    margin-left: 0px;
					    font-size: 26px;
					    font-weight: bolder;
				      ...
				      <div v-show="zklquery" style="position: absolute;margin-left: 80%;border-radius:5px;background-color:orange;width: 80px;height: 30px;
    					margin-top: 5px;" @click="openDate">
				      		<div style="color: white;text-align: center;    margin-top: 7px;">客流查询</div>
				      </div>
				      <div v-show="statochs" style="position: absolute;margin-left: 80%;border-radius:5px;background-color:orange;width: 80px;height: 30px;
    					margin-top: 5px;" @click="openState">
				      		<div style="color: white;text-align: center;    margin-top: 7px;">车站筛选</div>
				      </div>
				      <div style="position: absolute;margin-left: 87%;border-radius:5px;background-color:lightgreen;width: 80px;height: 30px;
    					margin-top: 5px;" @click="onFull">
				      		<div style="color: white;text-align: center;    margin-top: 7px;">全屏显示</div>
				      </div>
				      <div style="position: absolute;margin-left: 94%;border-radius:5px;background-color:#33CCFF;width: 60px;height: 30px;
    					margin-top:5px;" @click="onClose">
				      		<div style="color: white;text-align: center;    margin-top: 7px;">关闭</div>
				      </div>
				    </div>
		...
		this.timeReload();
		  ...
		  /* 	const data = [];
		        ...
		        cities.forEach((city, index) => {
		         ...
		         vueThis.slcdata=data; */
		         
		         
		  },
		   getCzchange:function(){
            var vueThis=this;
            
             var selTypes=[3];
             var stats=[];
             for (var i=0;i<=vueThis.stvalue.length-1;i++){
             	var it=vueThis.stvalue[i];
             	var st=vueThis.slcdata[it].label;
             			stats.push(st);
             	
             	/* for (var j=0;j<=vueThis.stvalue.length-1;j++){
             	
             		if(it==j){
             			var st=vueThis.slcdata[j].label;
             			stats.push(st);
             		}
					...
					$.post("sheete/get_all_change.action",{"id":0,"type":0,"date":vueThis.date,"size":10,"selType":selTypes,"stNames":stats}, function(data){
            		var da=data.chgst;
            		vueThis.qyklData=da;
          ...
          return item.stnName.indexOf(query) > -1;
        },
		  ...
		  getFlow:function(){
				...
				vueThis.compDt=vueThis.compDates.substring(0, 4) + "." + vueThis.compDates.substring(4, 6) + "." +vueThis.compDates.substring(6);
		  		...
		  		$.post("sumflw/GetpfwSmy.action",{"date":vueThis.temDates,"compDate":vueThis.compDates,"size":18}, function(data){
            ...
            var colors=['#ff7f50', '#87cefa', '#da70d6', '#32cd32', '#6495ed','#ff69b4', '#ba55d3', '#cd5c5c', '#ffa500', '#40e0d0','#1e90ff', '#ff6347', '#7b68ee', '#00fa9a', '#ffd700','#6b8e23', '#ff00ff', '#3cb371', '#b8860b', '#30e0e0'];
             var selTypes=[3];
				/*$('input[name="selType"]:checked').each(function(){
					...
					$.post("sheete/get_all_passc.action",{"id":0,"type":0,"date":vueThis.date,"size":10,"selType":selTypes}, function(data){
            		//$.post("distrc/GetDstpflw.action",{"date":vueThis.date,"size":20,"selType":selTypes}, function(data){
            		var da=data.chgst;
            		vueThis.slcdata=data.sta;
            		vueThis.qyklData=da;
            		vueThis.chgflData=data.chgln;
					var data_name = [];
					var item = {};
