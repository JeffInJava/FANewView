 ...
 *
 */
@JsonTagAnnotation(actionValue="/getime_paflw.action",namespace="/pasflw",isJsonReturn=true)
public class GetTimePFL  extends JsonTagTemplateDaoImpl implements IDoService{
